...
image:https://github.com/metanorma/mn-samples-jcgm/workflows/docker/badge.svg["Docker Build Status", link="https://github.com/metanorma/mn-samples-jcgm/actions?workflow=docker"]
