...
Since the initial publication of this _Guide_, several general and specific applications documents derived from this document have been published. For information purposes, nonexhaustive compilations of these documents can be found on http://www.bipm.org/en/committees/jc/jcgm/wg1_bibliography.html.
--
