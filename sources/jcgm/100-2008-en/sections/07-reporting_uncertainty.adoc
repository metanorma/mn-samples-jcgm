...
* the Type A and Type B combined standard uncertainties stem:[u_{"cA"}(y)] and stem:[u_{"cB"}(y)] and their estimated effective degrees of freedom stem:[ii(nu)_{"effA"}] and stem:[ii(nu)_{"effB"}] (see <<note3_G-4-1>>).
...
. include the relative expanded uncertainty stem:[ii(U)//|y|], stem:[|y| != 0], when appropriate;
