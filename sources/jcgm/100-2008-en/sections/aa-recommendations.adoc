...
The ((Working Group on the Statement of Uncertainties)) (see <<foreword>>) was convened in October 1980 by the Bureau International des Poids et Mesures (BIPM) in response to a request of the Comité International des Poids et Mesures (CIPM). It prepared a detailed report for consideration by the CIPM that concluded with Recommendation INC-1 (1980) <<KAARLS1981>>. The English translation of this Recommendation is given in <<scls_0-7>> of this _Guide_ and the French text, which is authoritative, is as follows <<KAARLS1981>>:(((BIPM)))(((CIPM)))
...
[[scls_A-2]]
=== Recommendation 1 (CI-1981)((("Recommendation 1 (CI-1981), CIPM")))
...
[[scls_A-3]]
=== Recommendation 1 (CI-1986)((("Recommendation 1 (CI-1986), CIPM")))

The ((CIPM)) further considered the matter of the expression of uncertainties at its 75th meeting held in October 1986 and adopted the following recommendation <<CIPM1987>>:(((combined standard uncertainty and Comités Consultatifs)))(((combined standard uncertainty and international comparisons)))
...
_considering_ the adoption by the ((Working Group on the Statement of Uncertainties)) of ((Recommendation INC-1 (1980))) and the adoption by the CIPM of Recommendation 1 (CI-1981)((("Recommendation 1 (CI-1981), CIPM"))),
