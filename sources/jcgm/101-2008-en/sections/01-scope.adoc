...
[[cls_1]]
== Scope (((GUM uncertainty framework (GUF))))(((model of measurement)))(((reporting the results)))(((uncertainty evaluation problems)))
...
* it is difficult or inconvenient to provide the partial derivatives(((partial derivative))) of the model, as needed by the law of ((propagation of uncertainty)) <<JCGM-100,clause=5>>,
...
Diled examples illustrate the guidance provided.
