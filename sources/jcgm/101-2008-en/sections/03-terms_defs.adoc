...
property of a pair of random variables, which, for two continuous random variables stem:[ii(X)_1] and stem:[ii(X)_2] characterized by a joint (multivariate) PDF stem:[g_{bb(X)} (bb(xi))], where stem:[ii(X) = (ii(X)_1, ii(X)_2)^T] and stem:[xi = (xi_1, xi_2)^T], is given by

[stem%unnumbered]
++++
"Cov"(ii(X)_1,ii(X)_2) = int_{-oo}^{oo} int_{-oo}{oo} [xi_1 - ii(E)(ii(X)_1)][xi_2 - ii(E)(ii(X)_2)] g_X (xi) " d"xi_1 " d"xi_2
++++
