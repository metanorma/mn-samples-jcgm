...
[[scls_5-1-1]]
==== {blank} (((Cauchy distribution)))(((coverage interval)))(((coverage probability)))(((estimate of output quantity)))(((knowledge,"about an input quantity")))(((model of measurement)))(((output quantity)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))(((probability density function (PDF),joint)))(((stages of uncertainty evaluation)))(((stages of uncertainty evaluation,formulation)))(((stages of uncertainty evaluation,propagation)))(((stages of uncertainty evaluation,summarizing)))(((standard deviation)))
...
.. determine the input quantities stem:[bb(X) = (ii(X)_1,..., ii(X)_N )^{sf(T)}] upon which stem:[ii(Y)] depends;
...
[[scls_5-1-2]]
==== {blank} (((GUM uncertainty framework (GUF))))(((probability)))(((probability density function (PDF),for input quantities)))(((Type A and Type B evaluations of uncertainty)))
...
==== {blank} (((stages of uncertainty evaluation,formulation)))(((stages of uncertainty evaluation,propagation)))(((stages of uncertainty evaluation,summarizing)))
...
=== Propagation of distributions (((distribution function,for output quantity)))(((Monte Carlo method (MCM))))(((probability density function (PDF),for output quantity)))(((propagation of distributions)))

In this Supplement a generally efficient approach for determining (a numerical approximation to) the ((distribution function))

[stem%unnumbered]
++++
G_Y (ii(eta)) = int_{-oo}^{ii(eta)} g_Y (z) " d"z
++++
...
[stem%unnumbered]
++++
g_Y (ii(eta)) = int_{-oo}^{oo} ... int_{-oo}^{oo} g_{bb(X)} (bb(xi)) delta(ii(eta) - f(bb(xi))) " d"xi_N... "d"xi_1,
++++

where stem:[delta(cdot)] denotes the Dirac delta function. This multiple integral cannot generally be evaluated analytically. A numerical integration rule can be applied to provide an approximation to stem:[g_Y (ii(eta))], but this is not an efficient approach.
====


=== Obtaining summary information

==== {blank} (((estimate of output quantity)))(((stages of uncertainty evaluation,summarizing)))(((standard deviation)))(((variance)))

An estimate stem:[y] of stem:[ii(Y)] is the ((expectation)) stem:[ii(E)(ii(Y))]. The ((standard uncertainty)) stem:[u(y)] associated with stem:[y] is given by the standard deviation of stem:[ii(Y)], the positive square root of the variance stem:[ii(V)(ii(Y))]  of stem:[ii(Y)].


[[scls_5-3-2]]
==== {blank} (((coverage interval)))(((coverage probability)))

A coverage interval for stem:[ii(Y)] can be determined from stem:[ii(G)_Y (ii(eta))]. Let stem:[alpha] denote any numerical value between zero and stem:[1 - p], where stem:[p] is the required coverage probability. The endpoints of a stem:[100p " %"] coverage interval for stem:[ii(Y)] are stem:[G_Y^{-1}(alpha)] and stem:[G_Y^{-1} (p + alpha)], i.e. the stem:[alpha]- and stem:[(p + alpha)]-quantiles of stem:[G_Y (ii(eta))].


[[scls_5-3-3]]
==== {blank} (((coverage factor)))(((coverage interval,probabilistically symmetric)))(((expanded uncertainty)))(((probability density function (PDF),symmetric)))
...
[[scls_5-3-6]]
==== {blank} (((coverage interval,probabilistically symmetric)))(((probability density function (PDF),asymmetric))) [[coverage_interval_shortest]]

<<fig1>> shows the ((distribution function)) stem:[G_Y (ii(eta))] corresponding to an asymmetric PDF. Broken vertical lines mark the endpoints of the probabilistically symmetric stem:[95 %] coverage interval and broken horizontal lines the corresponding probability points, viz. 0.025 and 0.975. Continuous lines mark the endpoints of the shortest stem:[95 %] coverage interval and the corresponding probability points, which are 0.006 and 0.956 in this case. The lengths of the stem:[95 %] coverage intervals in the two cases are 1.76 unit and 1.69 unit, respectively.


[[fig1]]
.A distribution function stem:[G_Y (ii(eta))] corresponding to an asymmetric PDF and the probabilistically symmetric and shortest stem:[95 %] coverage intervals (<<scls_5-3-6>>). "Unit" denotes any unit
image::figure1.png[]


=== Implementations of the propagation of distributions(((propagation of distributions,implementations of)))(((stages of uncertainty evaluation,propagation)))

==== {blank} (((Monte Carlo method (MCM))))(((propagation of distributions,analytical)))
...
==== {blank} (((GUM uncertainty framework (GUF))))(((model of measurement,linear)))
...
==== {blank} (((stages of uncertainty evaluation,propagation)))
...
[[scls_5-4-4]]
==== {blank} (((model of measurement,non-linear)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))

The propagation of the PDFs stem:[g_{ii(X)_i} (xi_i)], stem:[i = 1,..., ii(N)], for the input quantities stem:[ii(X)_i] through the model to provide the PDF stem:[g_Y (ii(eta))] for the output quantity stem:[ii(Y)] is illustrated in <<fig2>> for stem:[N = 3] independent stem:[ii(X)_i]. <<fig2>> may be compared to <<fig3>> for the law of ((propagation of uncertainty)). In <<fig2>>, the stem:[g_{ii(X)_i} (xi_i)], stem:[i = 1, 2, 3], are Gaussian, triangular, and Gaussian, respectively. stem:[g_Y(ii(eta))] is indicated as being asymmetric, as generally arises for non-linear models or asymmetric stem:[g_{ii(X)_i} (xi_i)].


[[fig2]]
.Illustration of the propagation of distributions for stem:[ii(N) = 3] independent input quantities (<<scls_5-4-4>>)
image::figure2.png[]
...
==== {blank} (((coverage interval)))(((coverage interval,probabilistically symmetric)))(((coverage interval,shortest)))(((coverage probability)))(((estimate of output quantity)))
...
. the stipulated coverage probability stem:[100p " %"] (e.g. stem:[95 %]);
. the endpoints of the selected stem:[100p " %"] coverage interval (e.g. stem:[95 %] coverage interval) for stem:[ii(Y)];
...
[stem%unnumbered]
++++
{:({:y = 1.024 "unitsml(V)"," "u(y) = 0.028 "unitsml(V)",:}),("shortest 95 % coverage interval" = [0.983, 1.088] "unitsml(V)".):}
++++
...
[stem%unnumbered]
++++
{:({:y = 1.02 "unitsml(V)", u(y) = 0.03 "unitsml(V)",:}),("shortest 95 % coverage interval" = [0.98, 1.09] "unitsml(V)".):}
++++


[[scls_5-6]]
=== GUM uncertainty framework index-range:gaussian_distribution[(((Gaussian distribution)))](((GUM uncertainty framework (GUF))))

==== {blank} (((Guide to the expression of uncertainty in measurement (GUM))))(((stages of uncertainty evaluation)))(((stages of uncertainty evaluation,propagation)))(((stages of uncertainty evaluation,summarizing)))
...
==== {blank} (((best estimate,of an input quantity)))(((coverage interval,from GUM uncertainty framework)))(((estimate of output quantity,from GUM uncertainty framework)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))(((standard deviation)))(((standard uncertainty,from GUM uncertainty framework)))
...
[[scls_5-6-3]]
==== {blank} (((correlated input quantities)))(((covariance)))(((coverage interval,from GUM uncertainty framework)))(((coverage probability)))(((degrees of freedom,effective)))(((estimate of output quantity,from GUM uncertainty framework)))(((expanded uncertainty)))(((expectation)))(((mutual uncertainty)))(((stages of uncertainty evaluation,propagation)))(((stages of uncertainty evaluation,summarizing)))(((standard deviation)))(((standard uncertainty,from GUM uncertainty framework)))(((Welch-Satterthwaite formula)))

The propagation and summarizing stages of the GUM uncertainty framework (stages <<item_5-1-1b>> and <<item_5-1-1c>> in <<scls_5-1-1>>) constitute the following computational steps. Also see <<fig3>>, which illustrates the law of ((propagation of uncertainty)) for a model having stem:[ii(N) = 3] independent input quantities stem:[bb(X) = (ii(X)_1, ii(X)_2, ii(X)_3)^{sf(T)}], which are estimated by stem:[x_i] with associated standard uncertainties stem:[u(x_i)], stem:[i = 1, 2, 3]. The output quantity stem:[ii(Y)] is estimated by stem:[y], with associated ((standard uncertainty)) stem:[u(y)].

. Obtain from the PDFs for the input quantities stem:[bb(X) = (ii(X)_1,..., ii(X)_N)^{sf(T)}] the expectations stem:[x = (x_1,..., x_N)^{sf(T)}] and the standard deviations (standard uncertainties) stem:[u(x) = [u(x_1),..., u(x_N )\]^{sf(T)}]. Use instead the joint PDF for stem:[ii(X)] if pairs of the stem:[ii(X)_i] are not independent (in which case they have non-zero covariance).
...
. Form the partial derivatives(((partial derivative))) of first order of stem:[f(bii(X))] with respect to stem:[bii(X)].
. Calculate stem:[y], the model evaluated at stem:[ii(X)] equal to stem:[x].
. Calculate the model ((sensitivity coefficients)) <<JCGM-100,clause=5.1.3>> as the above partial derivatives(((partial derivative))) evaluated at stem:[x].
...
. Calculate the expanded uncertainty stem:[U_p], and hence a coverage interval (for a stipulated coverage probability stem:[p]) for stem:[ii(Y)], regarded as a ((random variable)), by forming the appropriate multiple of stem:[u(y)] through taking the probability distribution of stem:[(ii(Y) - y)//u(y)] as a standard Gaussian distribution (stem:[nu_{"eff"} = oo]) or stem:[t]-distribution (stem:[nu_{"eff"} < oo]).


[[fig3]]
.Illustration of the law of propagation of uncertainty for stem:[ii(N) = 3] independent input quantities (<<scls_5-4-4>>, <<scls_5-6-3>>)
image::figure3.png[]


[[scls_5-7]]
=== Conditions for valid application of the GUM uncertainty framework for linear models (((GUM uncertainty framework (GUF),conditions for linear models)))(((model of measurement,linear)))
...
[[scls_5-7-2]]
==== {blank} (((central limit theorem)))(((coverage interval,from GUM uncertainty framework)))(((degrees of freedom,effective)))(((probability density function (PDF),for output quantity)))(((Welch-Satterthwaite formula)))
...
[[scls_5-8]]
=== Conditions for valid application of the GUM uncertainty framework for non-linear models [[gaussian_distribution]](((GUM uncertainty framework (GUF),conditions for non-linear models)))(((model of measurement,non-linear)))

[[scls_5-8-1]]
==== {blank} (((finite difference approximation)))(((GUM uncertainty framework (GUF),with higher-order terms)))
...
NOTE: If the analytical determination of the higher derivatives, required when the non-linearity of the model is significant, is difficult or error-prone, suitable software for automatic differentiation can be used. Alternatively, these derivatives can be approximated numerically using finite differences <<Conte1972>>. (The GUM provides a finite-difference formula for partial derivatives(((partial derivative))) of first order <<JCGM-100,clause=5.1.3 note 2>>.) Care should be taken, however, because of the effects of subtractive cancellation when forming differences between numerically close model values.


[[scls_5-8-2]]
==== {blank} (((coverage interval,from GUM uncertainty framework)))
...
[[scls_5-9]]
=== Monte Carlo approach to the propagation and summarizing stages (((Monte Carlo method (MCM))))(((stages of uncertainty evaluation,propagation)))(((stages of uncertainty evaluation,summarizing)))

==== {blank} (((distribution function,for output quantity)))

MCM provides a general approach to obtain an approximate numerical representation stem:[bb(G)], say, of the distribution function stem:[G_Y(ii(eta))] for stem:[ii(Y)] <<Lira2002,page=75>>. The heart of the approach is repeated sampling from the PDFs for the stem:[ii(X)_i] and the evaluation of the model in each case.


==== {blank}

Since stem:[ii(G)_Y (ii(eta))] encodes all the information known about stem:[ii(Y)], any property of stem:[ii(Y)] such as ((expectation)), variance and coverage intervals can be approximated using stem:[bb(G)]. The quality of these calculated results improves as the number of times the PDFs are sampled increases.
...
If stem:[y_r], for stem:[r = 1,..., ii(M)], represent stem:[ii(M)] model values sampled independently from a probability distribution for stem:[ii(Y)], then the ((expectation)) stem:[ii(E)(ii(Y))] and variance stem:[ii(V)(ii(Y))] can be approximated using the stem:[y_r]. In general, the moments of stem:[ii(Y)] (including stem:[ii(E)(ii(Y))] and stem:[ii(V)(ii(Y))]) are approximated by those of the sampled model values. Let stem:[ii(M)_{y_0}] denote the number of stem:[y_r] that are no greater than stem:[y_0], any prescribed number. The probability stem:["Pr"(ii(Y) <= y_0)] is approximated by stem:[M_{y_0}//ii(M)]. In this way, the stem:[y_r] provide a step function (histogram-like) approximation to the distribution function stem:[ii(G)_Y (ii(eta))].


==== {blank}

Each stem:[y_r] is obtained by sampling at random from each of the PDFs for the stem:[ii(X)_i] and evaluating the model at the sampled values so obtained. stem:[bb(G)], the primary output from MCM, constitutes the stem:[y_r] arranged in strictly increasing order.
...
[[scls_5-9-6]]
==== {blank} (((coverage interval,from Monte Carlo method)))(((coverage probability)))(((estimate of output quantity,from Monte Carlo method)))(((standard uncertainty,from Monte Carlo method)))
...
. generate stem:[ii(M)] vectors, by sampling from the assigned PDFs, as realizations of the (set of stem:[ii(N)]) input quantities stem:[ii(X)_i]. See <<scls_7-3>>;
. for each such vector, form the corresponding model value of stem:[ii(Y)], yielding stem:[ii(M)] model values. See <<scls_7-4>>;
. sort these stem:[ii(M)] model values into strictly increasing order, using the sorted model values to provide stem:[bb(G)]. See <<scls_7-5>>;
...
[[note2_5-9-6]]
NOTE: Mathematically, the average of the stem:[ii(M)] model values is a realization of a ((random variable)) with ((expectation)) stem:[ii(E)(ii(Y)] and variance stem:[ii(V)(ii(Y))//ii(M)]. Thus, the closeness of agreement between this average and stem:[ii(E)(ii(Y)] can be expected to be proportional to stem:[ii(M)^{-1//2}].
...
=== Conditions for the valid application of the described Monte Carlo method (((Monte Carlo method (MCM),conditions for application)))
...
. [[item_5-10-1d]]stem:[ii(E)(ii(Y))] and stem:[ii(V)(ii(Y))] exist;

. [[item_5-10-1e]]a sufficiently large value of stem:[ii(M)] is used.
...
NOTE: Condition <<item_5-10-1d>> is needed for (stochastic) convergence of MCM as the number stem:[ii(M)] of trials (see <<scls_7-2>>) increases.

NOTE: Condition <<item_5-10-1e>> is necessary to ensure that the summarizing information is reliable. See <<scls_8-2>>.


==== {blank} (((GUM uncertainty framework (GUF))))
...
=== Comparison of the GUM uncertainty framework and the described Monte Carlo method (((GUM uncertainty framework (GUF),comparison with a Monte Carlo method)))(((Monte Carlo method (MCM),comparison with GUM uncertainty framework)))
...
==== {blank} (((average,of a set of indications)))(((best estimate,of an input quantity)))((("indications, analysis of a series of")))(((knowledge,"about a quantity, prior")))(((probability)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))(((standard deviation,of a set of indications)))(((Type A and Type B evaluations of uncertainty)))
...
==== {blank} (((coverage interval)))(((distribution function,for output quantity)))(((estimate of output quantity)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))(((Type A and Type B evaluations of uncertainty)))
...
==== {blank} (((central limit theorem)))(((coverage factor)))(((coverage interval)))(((degrees of freedom,effective)))(((estimate of output quantity)))(((Gaussian distribution)))(((partial derivative)))(((Welch-Satterthwaite formula)))
