...
[[scls_5-1-1]]
==== {blank} (((Cauchy distribution)))(((coverage interval)))(((coverage probability)))
...
[[scls_5-3-4]]
==== {blank} index-range:coverage_interval_shortest[(((coverage interval,shortest)))]
...
[[scls_5-3-6]]
==== {blank} (((coverage interval,probabilistically symmetric))) [[coverage_interval_shortest]]
...
==== {blank} (((coverage interval)))(((coverage interval,probabilistically symmetric)))(((coverage interval,shortest)))(((coverage probability)))
...
==== {blank} (((best estimate,of an input quantity)))(((coverage interval,from GUM uncertainty framework)))
...
[[scls_5-6-3]]
==== {blank} (((correlated input quantities)))(((covariance)))(((coverage interval,from GUM uncertainty framework)))(((coverage probability)))
...
[[scls_5-7-2]]
==== {blank} (((central limit theorem)))(((coverage interval,from GUM uncertainty framework)))
...
==== {blank} (((average,of a set of indications)))(((best estimate,of an input quantity)))
...
==== {blank} (((central limit theorem)))(((coverage factor)))(((coverage interval)))
