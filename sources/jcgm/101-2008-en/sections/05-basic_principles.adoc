...
[[scls_5-1-2]]
==== {blank} (((GUM uncertainty framework (GUF))))(((probability)))(((probability density function (PDF),for input quantities)))
...
==== {blank} (((estimate of output quantity)))
...
=== Implementations of the propagation of distributions(((propagation of distributions,implementations of)))
...
==== {blank} (((Guide to the expression of uncertainty in measurement (GUM))))
...
==== {blank} (((best estimate,of an input quantity)))(((coverage interval,from GUM uncertainty framework)))(((estimate of output quantity,from GUM uncertainty framework)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))
...
[[scls_5-6-3]]
==== {blank} (((correlated input quantities)))(((covariance)))(((coverage interval,from GUM uncertainty framework)))(((coverage probability)))(((degrees of freedom,effective)))(((estimate of output quantity,from GUM uncertainty framework)))(((expanded uncertainty)))(((expectation)))(((mutual uncertainty)))
...
[[scls_5-7-2]]
==== {blank} (((central limit theorem)))(((coverage interval,from GUM uncertainty framework)))(((degrees of freedom,effective)))(((probability density function (PDF),for output quantity)))
...
[[scls_5-9]]
=== Monte Carlo approach to the propagation and summarizing stages (((Monte Carlo method (MCM))))
...
[[scls_5-9-6]]
==== {blank} (((coverage interval,from Monte Carlo method)))(((coverage probability)))(((estimate of output quantity,from Monte Carlo method)))
...
==== {blank} (((average,of a set of indications)))(((best estimate,of an input quantity)))((("indications, analysis of a series of")))(((knowledge,"about a quantity, prior")))(((probability)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))
...
==== {blank} (((coverage interval)))(((distribution function,for output quantity)))(((estimate of output quantity)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),for output quantity)))
...
==== {blank} (((central limit theorem)))(((coverage factor)))(((coverage interval)))(((degrees of freedom,effective)))(((estimate of output quantity)))(((Gaussian distribution)))(((partial derivative)))
