...
[[fig1]]
.A distribution function stem:[G_Y (ii(eta))] corresponding to an asymmetric PDF and the probabilistically symmetric and shortest 95 % coverage intervals (<<scls_5-3-6>>). "Unit" denotes any unit
image::figure1.png[]
