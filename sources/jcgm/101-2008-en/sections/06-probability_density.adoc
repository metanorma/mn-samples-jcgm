...
[[scls_6-4-8-1]]
===== {blank} (((best estimate,of a vector input quantity)))
...
[[scls_6-4-9-2]]
===== {blank} (((average,of a set of indications)))(((Bayes' theorem)))
...
[[scls_6-4-9-7]]
===== {blank} (((best estimate,from a calibration certificate)))(((calibration,certificate)))(((coverage factor)))
...
===== {blank} (((best estimate,of a non-negative input quantity)))
