...
==== {blank} ((("indications, analysis of a series of")))(((probability density function (PDF),for input quantities)))
...
[[scls_6-4-8-1]]
===== {blank} (((best estimate,of a vector input quantity)))(((multivariate Gaussian distribution,assignment to a vector quantity)))
...
[[scls_6-4-9-2]]
===== {blank} (((average,of a set of indications)))(((Bayes' theorem)))((("indications, analysis of a series of")))
...
===== {blank} (((average,of a set of indications)))(((best estimate,of an input quantity)))(((degrees of freedom,effective)))((("indications, analysis of a series of")))
...
[[scls_6-4-9-6]]
===== {blank} (((degrees of freedom,of a pooled standard deviation)))((("indications, analysis of a series of")))
...
[[scls_6-4-9-7]]
===== {blank} (((best estimate,from a calibration certificate)))(((calibration,certificate)))(((coverage factor)))(((degrees of freedom,effective)))(((expanded uncertainty)))
