...
[[scls_7-3]]
=== Sampling from probability distributions (((Monte Carlo method (MCM),sampling from probability distributions)))(((probability density function (PDF),for input quantities)))(((probability density function (PDF),joint)))(((probability density function (PDF),sampling from)))(((probability distribution,sampling from)))
...
[[scls_7-6]]
=== Estimate of the output quantity and the associated standard uncertainty (((average,of sampled model values)))(((coverage interval,from Monte Carlo method)))(((Estimate of output quantity,from Monte Carlo method)))(((probability density function (PDF),for input quantities)))
