...
==== {blank} (((coverage interval,from Monte Carlo method)))(((coverage probability)))
...
[[scls_7-6]]
=== Estimate of the output quantity and the associated standard uncertainty (((average,of sampled model values)))(((coverage interval,from Monte Carlo method)))
...
[[scls_7-9-4]]
==== Adaptive procedure (((coverage interval,probabilistically symmetric)))(((coverage interval,statistical)))
