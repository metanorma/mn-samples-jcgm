...
==== {blank} (((GUM uncertainty framework (GUF),validation of)))(((Monte Carlo method (MCM))))
...
==== {blank} (((coverage interval)))(((coverage interval,probabilistically symmetric)))(((coverage interval,shortest)))(((coverage probability)))(((GUM uncertainty framework (GUF),with higher-order terms)))
...
[stem]
++++
d_{"low"} = |y - ii(U)_{"p"} - y_{"low"}|,
++++

[[eq20]]
[stem]
++++
d_{"high"} = |y + ii(U)_{"p"} - y_{"high"}|,
++++
