...
Assign a scaled and shifted stem:[t]-distribution stem:[t_{nu} (mu, sigma^2)] (see <<scls_6-4-9-7>>) to stem:[ii(L)_s], with

[stem%unnumbered]
++++
mu = 50000623 " mn", " " sigma = ii(U)_{"p"}/k_{"p"} = 75/3 " nm" = 25 " nm", " " nu = 18.
++++
...
Assign a scaled and shifted stem:[t]-distribution stem:[t_{nu}(mu, sigma^2)] (see <<scls_6-4-9-2>> and <<scls_6-4-9-6>>) to stem:[ii(D)], with
