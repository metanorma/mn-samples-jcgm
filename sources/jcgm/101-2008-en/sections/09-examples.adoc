...
[stem]
++++
delta ii(L) = {ii(L)_s [1 + alpha_s (ii(theta)_0 + ii(Delta) - delta ii(theta))] + ii(D) + d_1 + d_2} / {1 + (alpha_s + delta alpha)(ii(theta)_0 + ii(Delta))}
++++
...
[stem%unnumbered]
++++
ii(mu) = 50000623 " "rm(nm), " " ii(sigma) = {U_p}/{k_p} = 75/3 " "rm(nm) = 25 " "rm(nm), " " nu = 18.
++++
