...
[[scls_9-2-2-8]]
===== {blank} (((coverage interval,length of)))
...
[[scls_9-2-4-5]]
===== {blank} (((central limit theorem)))(((coverage interval,probabilistically symmetric)))
...
===== {blank} (((best estimate,of an input quantity)))(((correlation coefficient)))(((covariance)))
...
[[scls_9-4-2-2-11]]
====== {blank} (((coverage interval,length of)))(((coverage interval,probabilistically symmetric)))(((coverage interval,shortest)))
...
[[scls_9-5]]
=== Gauge block calibration (((calibration,gauge block)))
...
===== {blank} (((average,of a set of indications)))
...
======  Information (((calibration,certificate)))(((coverage factor)))
...
======  Information (((average,of a set of indications)))
