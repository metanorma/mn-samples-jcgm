...
[stem%unnumbered]
++++
ii(V)(ii(X)) = ii(E)(X^2) - [ii(E)(ii(X))]^2.
++++
...
For the case stem:[x_1 = x_2 = r(x_1, x_2) = 0] and stem:[u(x_1) = u(x_2)], the PDF stem:[g_Y (eta)] for stem:[ii(Y)] can be obtained analytically. It is valuable to have such a solution for further validation purposes. In the above circumstances,
...
Let stem:[delta y_{alpha}] be that stem:[eta] in <<eqf3>> corresponding to stem:[ii(G)_Y (eta) = alpha] for any stem:[alpha] satisfying stem:[0 <= alpha <= 1-p]. Then
