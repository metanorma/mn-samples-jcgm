...
stem:[ii(E)(bb(X))]:: vector ((expectation)) of a vector random variable stem:[bb(X)]

stem:[ii(E)(ii(X)^r)]:: __r__th moment of a random variable stem:[ii(X)]

stem:["Ex"(lambda)]:: ((exponential distribution)) with parameter stem:[lambda]

stem:[f]:: mathematical model of measurement, expressed as a functional relationship between an output quan-tity stem:[ii(Y)] and the input quantities stem:[ii(X)_1,...,ii(X)_N] on which stem:[ii(Y)] depends

stem:[bb(G)]:: discrete representation of the distribution function stem:[ii(G)_Y(ii(eta))] for the output quantity stem:[ii(Y)] from a Monte Carlo procedure

stem:[G(alpha,ii(beta))]:: gamma distribution with parameters stem:[alpha] and stem:[ii(beta)]
...
stem:[g_{ii(X)_i}(xi_i)]:: probability density function with variable stem:[xi_i] for the input quantity stem:[ii(X)_i]

stem:[G_Y (ii(eta))]:: distribution function with variable stem:[ii(eta)] for the output quantity stem:[ii(Y)]

stem:[tilde(G)_Y (ii(eta))]:: continuous approximation to the distribution function stem:[ii(G)_Y (ii(eta))] for the output quantity stem:[ii(Y)]

stem:[g_Y (ii(eta))]:: probability density function with variable stem:[ii(eta)] for the output quantity stem:[ii(Y)]

stem:[tilde(g)_Y (ii(eta))]:: derivative of stem:[ii(G)_Y (ii(eta))] with respect to stem:[ii(eta)], providing a numerical approximation to the probability density function stem:[g_Y(ii(eta))] for the output quantity stem:[ii(Y)]
...
stem:[ii(M)]:: number of Monte Carlo trials

stem:[N]:: number of input quantities stem:[ii(X)_1,..., ii(X)_N]

stem:[N(0, 1)]:: standard Gaussian distribution

stem:["N"(ii(mu),ii(sigma)^2)]:: Gaussian distribution with parameters stem:[ii(mu)] and stem:[ii(sigma)^2]
...
stem:[p]:: integer part of stem:[pii(M) + 1//2]
...
stem:["Trap"(a,b,ii(beta))]:: trapezoidal distribution over the interval stem:[[a,b\]] with parameter stem:[ii(beta)]

stem:[t_{nu}]:: central stem:[t]-distribution with stem:[nu] ((degrees of freedom))

stem:[t_{nu} (ii(mu), ii(sigma)^2)]:: scaled and shifted stem:[t]-distribution with parameters stem:[ii(mu)] and stem:[ii(sigma)^2], and stem:[nu] ((degrees of freedom))
...
stem:[ii(X)]:: vector stem:[(ii(X)_1,..., ii(X)_N )^{sf(T)}] of input quantities, regarded as random variables, on which the output quantity stem:[ii(Y)] depends

stem:[ii(X)_i]:: __i__th input quantity, regarded as a random variable, on which the output quantity stem:[ii(Y)] depends

stem:[x]:: estimate (expectation) of stem:[ii(X)]

stem:[bb(x)]:: vector estimate (vector expectation) stem:[(x_1,...,x_N)^{sf(T)}] of stem:[bb(X)]

stem:[bar(x)]:: average of a series of stem:[n] indications stem:[x_1,..., x_n]
...
stem:[bb(x)_r]:: __r__th Monte Carlo draw, containing values stem:[x_{1,r},..., x_{ii(N),r}], drawn from the probability density functions for the stem:[ii(N)] input quantities stem:[ii(X)_1,..., ii(X)_N] or from the joint probability density function for stem:[bb(X)]

stem:[ii(Y)]:: (scalar) output quantity, regarded as a random variable

stem:[y]:: estimate (expectation) of stem:[ii(Y)]

stem:[tilde(y)]:: estimate of stem:[ii(Y)], obtained as the average of the stem:[ii(M)] model values stem:[y_r] from a Monte Carlo run or as the expectation of stem:[ii(Y)] characterized by the probability density function stem:[g_Y (ii(eta))]
...
stem:[ii(beta)]:: parameter of a trapezoidal distribution equal to the ratio of the semi-width of the top of the trapezoid to that of the base

stem:[ii(beta)]:: parameter of a gamma distribution

stem:[ii(Gamma)(z)]:: function with variable stem:[z]

stem:[delta]:: ((numerical tolerance)) associated with a numerical value

stem:[delta(z)]:: Dirac delta function with variable stem:[z]

stem:[ii(eta)]:: variable describing the possible values of the output quantity stem:[ii(Y)]
...
stem:[ii(mu)]:: expectation of a quantity characterized by a probability distribution
...
stem:[ii(sigma)]:: standard deviation of a quantity characterized by a probability distribution

stem:[ii(sigma)^2]:: variance (squared standard deviation) of a quantity characterized by a probability distribution

stem:[ii(Phi)]:: phase of a quantity that cycles sinusoidally
