...
stem:[G_Y (eta)]:: continuous approximation to the distribution function stem:[ii(G)_Y (eta)] for the output quantity stem:[ii(Y)]
...
stem:[ii(X)]:: vector stem:[(ii(X)_1,..., ii(X)_N )^T] of input quantities, regarded as random variables, on which the output quantity stem:[ii(Y)] depends
