...
stem:[bb(G)]:: discrete representation of the distribution function stem:[ii(G)_Y(eta)] for the output quantity stem:[ii(Y)] from a Monte Carlo procedure
...
stem:[tilde(G)_Y (eta)]:: continuous approximation to the distribution function stem:[ii(G)_Y (eta)] for the output quantity stem:[ii(Y)]

stem:[g_Y (eta)]:: probability density function with variable stem:[eta] for the output quantity stem:[ii(Y)]

stem:[tilde(g)_Y (eta)]:: derivative of stem:[ii(G)_Y (eta)] with respect to stem:[eta], providing a numerical approximation to the probability density function stem:[g_Y(eta)] for the output quantity stem:[ii(Y)]
